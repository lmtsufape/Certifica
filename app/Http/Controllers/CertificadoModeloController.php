...
class CertificadoModeloController extends Controller
{
    ...
    public function store(StoreCertificadoModeloRequest $request)
    {
        ...
        $certificado_modelo->logo = $request->logo->store('public/modelos');
    ...
    public function show($id)
    {
        ...
        return view('certificado_modelo.certificado_modelo_show', ['modelo' => $modelo, 'imagem' => $img, 'verso' => $verso, 'logo' => $logo]);
    }
