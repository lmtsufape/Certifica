    ...
    @if(Auth::check())
        @if(Auth::user()->perfil_id == 1)
            <ul class="navbar-nav ms-auto mr-4">
                ...
                <li><a class="dropdown-item" href=" {{ route('unidade_administrativa.index') }} ">Unidades Administrativas</a></li>
                ...
                <li><a class="dropdown-item" href=" {{ route('certificado_modelo.index') }} ">Modelo de Certificado</a></li>
            </ul>
