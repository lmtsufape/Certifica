@foreach ($acoes as $acao)
    <div class="row linha-table d-flex align-items-center justify-content-start">
        ...
        <div title="{{$acao->tipo_natureza->descricao}}" class="col-2 text-center titulo-span">
            <span>{{$acao->tipo_natureza->descricao}}</span></div>
        ...
        <div class="col-2 d-flex align-items-center justify-content-evenly">
            <span><a href="" data-bs-toggle="modal" data-bs-target="#modal-info{{$acao->id}}"><img
            ...
            @if ($acao->status == null)
                ...
                @if(Auth::user()->perfil_id == 3)
                    <span>
                        <a href="{{ Route('gestor.gerar_certificados', ['acao_id' => $acao->id]) }}" onclick="return confirm('Você tem certeza que deseja emitir os certificados?')">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <span><b>Status: </b>@if($acao->status)
                                {{$acao->status}}
                            @else
                                Não submetida
                            @endif</span>
