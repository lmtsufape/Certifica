...
@section('content')
    ...
    <form class="container form" action="{{ Route('participante.update') }}" method="POST"
        ...
        <div class="row d-flex aligm-items-start justify-content-start ">
            ...
            <div class="col-7 spacing-row1 input-create-box d-flex align-items-start justify-content-start flex-column">
                ...
                <input class="w-75 input-text " type="text" name="nome" id="" value="{{$participante->user->name}}"
                       disabled>
            </div>
        ...
        <div class="row d-flex aligm-items-start justify-content-start ">
            ...
            <div class="col-7 spacing-row1 input-create-box d-flex align-items-start justify-content-start flex-column">
                ...
                <input class="w-75 input-text " type="email" name="email" id=""
                       placeholder="example@gmail.com" value="{{$participante->user->email}}" disabled>
            </div>
        ...
        <div class="row d-flex aligm-items-start justify-content-start ">
            ...
            <div class="col-7 spacing-row1 input-create-box d-flex align-items-start justify-content-start flex-column">
                ...
                <input class="w-75 input-text " type="text" name="titulo" id="" value="{{$participante->titulo}}" required>
            </div>
        ...
        <div class="alert alert-warning text-center mb-0 mt-2" role="alert"><strong>Atenção:</strong>
            <small style="color: red">É necessário editar o perfil do usuário vinculado a este CPF para alterar as informações de Nome, Email e CPF.</small>
        </div>
