        ...
        @foreach ($atividades as $atividade)
            ...
            <div class="modal fade" id="modalImportTrabalhoCsv{{ $atividade->id }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalImportCsvLabel">Importar XLSX com os Dados dos Trabalhos e
                                Autores
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <form class="form"
                                    ...
                                    <div class="row align-items-start">
                                        <div>
                                            <input type="file" accept=".xlsx" name="trabalhos_xlsx" id="trabalhos_xlsx"
